...
export const addProduct = createAsyncThunk("products/addProduct", async ({productName, productPrice, productQuantity, callback}) => {
...
// don't need to create action creators
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(addProduct.fulfilled, (state, action) => state.push(action.payload))
  }
})